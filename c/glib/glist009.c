...
int main (int argc, char **argv) {
	GSList *list = g_slist_append(NULL, "Anahein "), *iterator = NULL;
	...
	printf("After inserting 'Boston', second item is %s\n", g_slist_nth(list, 1)->data);
	...
	printf("After inserting 'Denver', here is the final list:\n");
