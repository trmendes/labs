...
typedef int32_t (*compare_ft) (void * key1, void * key2);
...
list_t *        dlist_init           (destroy_ft destroy, compare_ft compare,
		print_ft print);
void            dlist_destroy        (list_t **list);
lst_element_t * dlist_find_element   (list_t *list, void *data);
int8_t          dlist_ins_next       (list_t *list, void * element, void
		*data);
int8_t          dlist_rem_next       (list_t *list, void * element, void
		**data);
int8_t          dlist_ins_prev       (list_t *list, void * element, void
		*data);
int8_t          dlist_rem_prev       (list_t *list, void * element, void
		**data);
